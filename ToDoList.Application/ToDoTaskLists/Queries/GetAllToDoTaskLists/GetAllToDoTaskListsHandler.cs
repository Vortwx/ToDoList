...
public class GetAllToDoTaskListsHandler : IRequestHandler<GetAllToDoTaskLists, ToDoTaskListDto>
{
    ...
    {
        var taskLists = await _toDoTaskListRepository.GetAllTaskListsAsync();
